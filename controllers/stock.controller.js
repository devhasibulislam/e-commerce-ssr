...
exports.insertNewStock = async (req, res, next) => {
  try {
    ...
    res.status(201).json({
      ...
      message: "Created",
      description: "New stock insert successfully",
      data: result,
    });
  } catch (error) {
    next(error);
...
exports.displayAllStocks = async (req, res, next) => {
  try {
    ...
    res.status(200).json({
      ...
      message: "OK",
      count: result.length,
      description: "Successfully fetch all stocks",
      data: result,
    });
  } catch (error) {
    next(error);
...
exports.displaySpecificStock = async (req, res, next) => {
  try {
    ...
    res.status(200).json({
      acknowledgement: true,
      message: "OK",
      description: "Successfully fetch specific stock",
      data: result,
    });
  } catch (error) {
    next(error);
...
exports.removeSpecificStock = async (req, res, next) => {
  try {
    ...
    res.status(202).json({
      acknowledgement: true,
      message: "Accepted",
      description: "Successfully remove specific stock",
      data: result,
    });
  } catch (error) {
    next(error);
